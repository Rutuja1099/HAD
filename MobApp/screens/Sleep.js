        ...
        <SafeAreaView className="  bg-white flex-1 relative">
          ...
          <View className="bg-sky-950 flex-1 text-white p-2">
                <View className = "p-4 flex-row items-center">
                    ...
                    {i18n.t("sleepPage.title")}
                    </Text>
                </View>
                    <View style={styles.container}>
                    <ImageBackground source={image1} resizeMode="cover" style={styles.image}>
                        <View style={styles.ImageContainer}>
                        <Text style={styles.subtitle}>{i18n.t("sleepPage.subTitle")} </Text>
                        <Text style={styles.dayText}>
                          {i18n.t("sleepPage.paraLine1")}
                          {i18n.t("sleepPage.paraLine2")}
                                </Text>
                        ...
                        <View style={styles.innercontainer}>
                            ...
                            <Pressable disabled={!visibleState} onPress={()=>setVisibleState(false)}>
                                <Text style={styles.subtitle}>{i18n.t("sleepPage.heading1")}</Text></Pressable>
                            <View disabled={visibleState} style={styles.textContainer}>
                            <Text style={styles.dayText}>
                                {i18n.t("sleepPage.step1")}</Text>
                            <Text style={styles.dayText}>
                                {i18n.t("sleepPage.step2")} </Text>
                            <Text style={styles.dayText}>
                                {i18n.t("sleepPage.step3")} </Text>
                            <Text style={styles.dayText}>
                                {i18n.t("sleepPage.step4")} </Text>
                            <Text style={styles.dayText}>
                                {i18n.t("sleepPage.step5")}
                                </Text>
                            </View>
